...
namespace WebAPI.Controllers
{
    ...
    public class PlayerStatsController : FootballLeagueControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ResponseData<IEnumerable<PlayerStatsDto>>>> CreatePlayerStats(CreatePlayerStatsDto playerStats)
        {
            try
            {
        ...
        public async Task<ActionResult<ResponseData<IEnumerable<PlayerStatsDto>>>> DeletePlayerStat(int playerStatId)
        {
            try
            {
        ...
        [HttpGet("Type")]
        public async Task<ActionResult<ResponseData<IEnumerable<PlayerStatTypeDto>>>> GetAllPlayerStatTypes()
        {
            try
            {
